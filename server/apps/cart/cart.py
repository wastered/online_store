...
class Cart:
    ...
    def add(self, product, quantity, override_quantity=False):
        ...
        :param quantity: Целое число с количеством товара.
        :param override_quantity: Булево значение, указывающее, нужно ли заменить quantity переданным количеством.
        :return: None
        """
    ...
    def __len__(self):
        ...
        :return: Числовое значение суммы количеств всех товаров в корзине.
        """
